...
from opencood.data_utils.dair_datasets import build_dataset
...
def main():
    ...
    if run_test:
        ...
        cmd = f"python /home/yty/mfh/code/inter/Where2comm/opencood/tools/inference_dair.py --model_dir {saved_path} --fusion_method {fusion_method}"
