...
class IntermediateFusionDatasetCarlaInfer(Dataset):
    """
    ...
    def retrieve_base_data(self, idx):
        ...
        ######################## Single View GT ########################
        # infra_lidar_path = os.path.join(self.root_dir, 'infrastructure-side/velodyne/{}.bin'.format(int(veh_frame_id) - 1))
        infra_lidar_path = os.path.join(self.root_dir, frame_info['infrastructure_pointcloud_bin_path_t_0'])
